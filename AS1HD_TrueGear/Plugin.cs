...
using Il2CppVertigo.AZS2.Melee;
using UnityEngine;
using System.Collections.Generic;
using Vertigo.AZS2.Client;

namespace AS1HD_TrueGear
{
    ...
    public class Plugin : BasePlugin
    {
        ...
        //private static System.Threading.Timer flameThrowerShoot = null;
        ...
        public static void PlayerHittableModulee_HandleOnHitEvent_Prefix(Vertigo.AZS2.Client.PlayerHittableModule __instance, HitArgs args)
        {
            ...
            if (playerHealth > 0f)
            {
                ...
                if (playerHealth < maxPlayerHealth * 0.33f)
                {
                    Log.LogInfo("-----------------------------------------------");
        ...
        //        if (__instance.HealthValue < __instance.MaxHealth * 0.33f)
        //        {
        //            Log.LogInfo("-----------------------------------------------");
        //            Log.LogInfo("StartHeartBeat");
        //            _TrueGear.StartHeartBeat();
        ...
        [HarmonyPostfix, HarmonyPatch(typeof(Il2CppVertigo.AZS2.Client.BHapticsPlayerController), "HandleOnInteractableInsertedIntoLeftWristSlotEvent")]
        public static void BHapticsPlayerController_HandleOnInteractableInsertedIntoLeftWristSlotEvent_Postfix(Il2CppVertigo.AZS2.Client.BHapticsPlayerController __instance,  InteractableHandle handle)
        {
            if (Vertigo.AZS2.Client.PawnUtils.IsLocalPawnSlot(handle.Slot))
            {
                Log.LogInfo("-----------------------------------------------");
        ...
        [HarmonyPostfix, HarmonyPatch(typeof(Il2CppVertigo.AZS2.Client.BHapticsPlayerController), "HandleOnInteractableInsertedIntoRightWristSlotEvent")]
        public static void BHapticsPlayerController_HandleOnInteractableInsertedIntoRightWristSlotEvent_Postfix(Il2CppVertigo.AZS2.Client.BHapticsPlayerController __instance, InteractableHandle handle)
        {
            if (Vertigo.AZS2.Client.PawnUtils.IsLocalPawnSlot(handle.Slot))
            {
                Log.LogInfo("-----------------------------------------------");
        ...
        [HarmonyPostfix, HarmonyPatch(typeof(Il2CppVertigo.AZS2.Client.BHapticsPlayerController), "HandleOnInteractableRemovedFromLeftWristSlotEvent")]
        public static void BHapticsPlayerController_HandleOnInteractableRemovedFromLeftWristSlotEvent_Postfix(Il2CppVertigo.AZS2.Client.BHapticsPlayerController __instance, InteractableHandle handle)
        {
            if (Vertigo.AZS2.Client.PawnUtils.IsLocalPawnSlot(handle.Slot))
            {
                Log.LogInfo("-----------------------------------------------");
        ...
        [HarmonyPostfix, HarmonyPatch(typeof(Il2CppVertigo.AZS2.Client.BHapticsPlayerController), "HandleOnInteractableRemovedFromRightWristSlotEvent")]
        public static void BHapticsPlayerController_HandleOnInteractableRemovedFromRightWristSlotEvent_Postfix(Il2CppVertigo.AZS2.Client.BHapticsPlayerController __instance, InteractableHandle handle)
        {
            if (Vertigo.AZS2.Client.PawnUtils.IsLocalPawnSlot(handle.Slot))
            {
                Log.LogInfo("-----------------------------------------------");
        ...
        public static void MuzzleSlideSprintChecker_OnRightHandSlotInteractableRemoved_Postfix(Il2CppVertigo.AZS2.Client.MuzzleSlideSprintChecker __instance)
        {
            if (!isRightHandRemoveItem)
            {
                ...
                System.Threading.Timer rightHandRemoveItemTimer = new System.Threading.Timer(RightHandRemoveItemTimerCallBack, null, 5, Timeout.Infinite);
            }
        }
        ...
        public static void MuzzleSlideSprintChecker_OnLeftHandSlotInteractableRemoved_Postfix(Il2CppVertigo.AZS2.Client.MuzzleSlideSprintChecker __instance)
        {
            if (!isLeftHandRemoveItem)
            {
                ...
                System.Threading.Timer leftHandRemoveItemTimer = new System.Threading.Timer(LeftHandRemoveItemTimerCallBack, null, 5, Timeout.Infinite);
            }
        }
        ...
        [HarmonyPostfix, HarmonyPatch(typeof(Vertigo.AZS2.Melee.StabStrategy), "DoHit")]
        public static void StabStrategy_DoHit_Postfix(Vertigo.AZS2.Melee.StabStrategy __instance, HittableBehaviour hittableBehaviour)
        {
        ...
        private static void DeviceHapticsSystem_PlayHaptics1_Postfix(DeviceHapticsSystem __instance, EControllerRole controllerRoleMask, uint hapticsProfileId, bool loopHaptics = false)
        {
            ...
            //System.Threading.Timer flamethrowerTimer = new System.Threading.Timer(flamethrowerTimerCallBack, null, 10, Timeout.Infinite);
        ...
        //    }
        //    Log.LogInfo(controllerRoleMask);
        //    flameThrowerShoot = new System.Threading.Timer(FlameThrowerShootTimerCallBack, null, 10, Timeout.Infinite);
        ...
        public static void MenuViewBehaviour_OpenCloseMenu_Prefix(Vertigo.AZS2.Client.MenuViewBehaviour __instance, bool isOpen)
        {
            ...
            else if (!isOpen && playerHealth < maxPlayerHealth * 0.33f)
            {
                Log.LogInfo("-----------------------------------------------");
                Log.LogInfo("StartHeartBeat");
                _TrueGear.StartHeartBeat();
        ...
        [HarmonyPrefix, HarmonyPatch(typeof(SlideChamberMechanicBehaviourData), "HandleOnSlideStateChangedEvent")]
        public static void SlideChamberMechanicBehaviourData_HandleOnSlideStateChangedEvent_Prefix(SlideChamberMechanicBehaviourData __instance, SlideChamberMechanic.ESlideState state)
        {

            Log.LogInfo("-----------------------------------------------");
            Log.LogInfo("HandleOnSlideStateChangedEvent");
            Log.LogInfo(state);
        }
